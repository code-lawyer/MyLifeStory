...
import { router as generateWorldRouter } from './generate-world.js';
import { router as generateBulkRouter } from './generate-bulk.js';
...
router.use('/generate', generateWorldRouter);
router.use('/generate', generateBulkRouter);
